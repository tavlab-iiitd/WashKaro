...
public class aboutActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        names = new String[]{ getString(R.string.rohan),getString(R.string.vaibhav),getString(R.string.priyanka),
        ...
        sal = new String[]{getString(R.string.rohan_tag),getString(R.string.vaibhav_tag),getString(R.string.priyanka_tag),
        ...
        urls=new String[]{"https://www.linkedin.com/in/rohan-pandey-145170175/","https://www.linkedin.com/in/vaibhav-gautam-171775187/",
