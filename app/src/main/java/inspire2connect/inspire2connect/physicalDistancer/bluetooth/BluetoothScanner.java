...
import static inspire2connect.inspire2connect.physicalDistancer.base.Base.Logd;
import static inspire2connect.inspire2connect.physicalDistancer.base.Base.Logv;
...
public class BluetoothScanner {
    ...
    public void stopScanning() {
        ...
        PhysicalDistancerActivity.isSafe = true;
    ...
    private class BluetoothScanCallback extends ScanCallback {
        ...
        private void sendNotificationOnResult(ScanResult result) {
            PhysicalDistancerActivity.isSafe = false;
...
//        Logging.updateLog(UUID);
            ...
            if (!isPresent) {
                ...
                Intent intent = new Intent(context, PhysicalDistancerActivity.class);
