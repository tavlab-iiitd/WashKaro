...
public class Story_Details implements Comparable<Story_Details>
{
    ...
    public String getWho_url(){return who_url;}
    public String getWho_article_text(){return who_article_text;}
    public String getWho_summary(){return who_summary;}
    public int getNumber(){return number;}
    public String getUrl(){return url;}
    public int getNumber_of_relevant_votes(){ return number_of_relevant_votes;}
    public int getNumber_of_irrelevant_votes() { return number_of_irrelevant_votes;}
